...
|---|---:|---|
| No-hit live remesh event ledger | pass | selection `no-hit divergent gap`, raw/post-filter `0/0`, candidate/applied `1/1`, q1/q2 `0/1`, new oceanic `1` (`1.000` sample-eq), rifting pending `0` (`0.000` continental fraction), overwritten `0`, no-overwrite `1`, ledger reconciles `1`, reset `0->1`, policy/prior/projection `0/0/0`, q/zGamma `1/1`, geophysics/paper zGamma `1/0`, topology `4f877056e71d554d`, event `99b2957f76910bf5`. |
| Filter-exhausted continental rifting-pending route | pass | selection `divergent gap after filtering`, raw/post-filter `2/0`, candidate/applied `1/0`, q1/q2 `0/1`, new oceanic `0` (`0.000` sample-eq), rifting pending `1` (`1.000` continental fraction), overwritten `0`, no-overwrite `1`, ledger reconciles `1`, reset `0->1`, policy/prior/projection `0/0/0`, q/zGamma `1/1`, geophysics/paper zGamma `1/0`, topology `727f492f1e99c50e`, event `c831ae271c71c124`. |
...
- Stop if continental divergent candidates apply generated oceanic crust instead of routing to `rifting pending`.
