...
| mixed-material distance tie fallback layer 1 - continental priority | pass | resolved `1`, plate `6`, bucket `mixed_material`, nearest `distance_tie_held`, fallback `continental_priority`, flags shared/nearest/dtie `0/0/1`, policy/prior `0/0` |
