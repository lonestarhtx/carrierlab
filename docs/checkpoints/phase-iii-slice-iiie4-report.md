...
- `zBar(p)` is independently distance-interpolated between the q1/q2 boundary elevations. `zGamma(p)` uses the named IIIE.4 ridge-profile convention anchored to thesis Table 3.2 constants: ridge peak `-1 km`, abyssal plain `-6 km`, linearly parameterized by the same ridge-to-boundary alpha until a more detailed profile curve is extracted.
...
|---|---:|---|
| no-hit divergent oceanic generation | pass | class `no-hit divergent gap`, generated `1`, boundary `1`, anomaly `0`, rejected `0/0`, q1/q2 `0/1`, assigned `0`, signed velocity `0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `0fc06efc6a92253b`. |
| filter-exhausted divergent oceanic generation | pass | class `divergent gap after filtering`, generated `1`, boundary `1`, anomaly `0`, rejected `0/0`, q1/q2 `0/1`, assigned `0`, signed velocity `0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `e9052ba3fa60a5dd`. |
| non-separating q1/q2 anomaly | pass | class `no-hit divergent gap`, generated `0`, boundary `1`, anomaly `1`, rejected `0/0`, q1/q2 `0/1`, assigned `-1`, signed velocity `-0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `91ab557101086280`. |
| resolved single-hit route rejected | pass | class `resolved single hit`, generated `0`, boundary `0`, anomaly `0`, rejected `1/0`, q1/q2 `-1/-1`, assigned `-1`, signed velocity `0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `542d1b822c77773c`. |
| unresolved multi-hit route rejected | pass | class `unresolved mixed-material multi-hit`, generated `0`, boundary `0`, anomaly `0`, rejected `1/1`, q1/q2 `-1/-1`, assigned `-1`, signed velocity `0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `251e526a1f992b5e`. |
| no two-plate boundary pair anomaly | pass | class `no-hit divergent gap`, generated `0`, boundary `0`, anomaly `0`, rejected `0/0`, q1/q2 `-1/-1`, assigned `-1`, signed velocity `0.002`, age `0`, elevation residual `0`, ridge residual `0`, radial dot `0`, hash `e5e8edfef4290c4c`. |
...
| New oceanic crust age is zero | Generation records `OceanicAge = 0` and gates residual against an independent oracle | Mutate global samples only inside the remesh event | Generated sample field residuals |
